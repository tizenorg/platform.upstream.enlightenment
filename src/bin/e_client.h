...
struct E_Client
{
   ...
   Eina_Bool external_output_client : 1; //external output related
...
/* External output related */
E_API Eina_Bool e_client_external_output_client_check(E_Client *ec, struct wl_resource *output_resource);
