...
EAPI void e_comp_ignore_win_add(E_Pixmap_Type type, uint64_t win);
EAPI void e_comp_ignore_win_del(E_Pixmap_Type type, uint64_t win);
EAPI Eina_Bool e_comp_ignore_win_find(uint64_t win);
