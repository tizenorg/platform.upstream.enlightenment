...
E_API int E_EVENT_CONFIG_ICON_THEME = 0; // TODO: should be removed - yigl
...
#define D _e_config_edd
   ...
   E_CONFIG_VAL(D, T, no_module_delay, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_LIST(D, T, modules, _e_config_module_edd); /**/
   EET_DATA_DESCRIPTOR_ADD_LIST_STRING(D, T, "bad_modules", bad_modules); // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, mouse_bindings, _e_config_bindings_mouse_edd); /**/ // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, key_bindings, _e_config_bindings_key_edd); /**/ // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, edge_bindings, _e_config_bindings_edge_edd); /**/ // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, signal_bindings, _e_config_bindings_signal_edd); /**/ // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, wheel_bindings, _e_config_bindings_wheel_edd); /**/ // TODO: should be removed - yigl
   //E_CONFIG_LIST(D, T, acpi_bindings, _e_config_bindings_acpi_edd); /**/ // TODO: should be removed - yigl
   ...
   E_CONFIG_VAL(D, T, use_resist, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, drag_resist, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desk_resist, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, window_resist, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, maximize_policy, INT); /**/
   E_CONFIG_VAL(D, T, allow_manip, INT); /**/
   E_CONFIG_VAL(D, T, allow_above_fullscreen, INT); /**/ // TODO: should be removed - yigl
   ...
   E_CONFIG_VAL(D, T, transition_start, STR); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, transition_desk, STR); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, transition_change, STR); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, move_info_follows, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, resize_info_follows, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, move_info_visible, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, resize_info_visible, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, focus_last_focused_per_desktop, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, focus_revert_on_hide_or_close, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, pointer_slide, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, disable_all_pointer_warps, INT); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, pointer_warp_speed, DOUBLE); /**/ // TODO: should be removed - yigl
   ...
   E_CONFIG_VAL(D, T, desklock_passwd, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_pin, INT); // TODO: should be removed - yigl
   E_CONFIG_LIST(D, T, desklock_backgrounds, _e_config_desklock_bg_edd); /**/ // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_auth_method, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_login_box_zone, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_start_locked, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_on_suspend, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_autolock_screensaver, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_post_screensaver_time, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_autolock_idle, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_autolock_idle_timeout, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_use_custom_desklock, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_custom_desklock_cmd, STR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_ask_presentation, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desklock_ask_presentation_timeout, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_enable, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_timeout, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_interval, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_blanking, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_expose, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_ask_presentation, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_ask_presentation_timeout, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_wake_on_notify, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_wake_on_urgent, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_suspend, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_suspend_on_ac, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, screensaver_suspend_delay, DOUBLE); // TODO: should be removed - yigl
   ...
   E_CONFIG_VAL(D, T, desk_flip_wrap, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, fullscreen_flip, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, multiscreen_flip, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, icon_theme, STR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, icon_theme_overrides, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desk_flip_animate_mode, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desk_flip_animate_type, STR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, desk_flip_animate_interpolation, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, theme_default_border_style, STR);
   E_CONFIG_VAL(D, T, desk_auto_switch, INT); // TODO: should be removed - yigl
   ...
   E_CONFIG_VAL(D, T, mode.presentation, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, mode.offline, UCHAR); // TODO: should be removed - yigl
   E_CONFIG_LIST(D, T, env_vars, _e_config_env_var_edd);
   E_CONFIG_VAL(D, T, powersave.none, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.low, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.medium, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.high, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.extreme, DOUBLE); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.min, INT); // TODO: should be removed - yigl
   E_CONFIG_VAL(D, T, powersave.max, INT); // TODO: should be removed - yigl
...
#define D _e_config_bindings_key_edd
   ...
   _e_config_bindings_edge_edd = E_CONFIG_DD_NEW("E_Config_Binding_Edge", E_Config_Binding_Edge);
#undef T
#undef D
...
#define D _e_config_bindings_wheel_edd
   ...
   _e_config_bindings_acpi_edd = E_CONFIG_DD_NEW("E_Config_Binding_Acpi", E_Config_Binding_Acpi);
#undef T
#undef D
