...
EAPI Eina_Stringshare *e_coml_wl_input_keymap_path_get(const char *rules, const char *model, const char *layout);
EAPI struct xkb_keymap *e_comp_wl_input_keymap_compile(struct xkb_context *ctx, const char *rules, const char *model, const char *layout, char **keymap_path);
