...
_e_comp_drm_mode_screen_find(E_Output *eout, Ecore_Drm_Output *output)
{
        ...
        EINA_LIST_FOREACH(dev->outputs, ll, output)
          {
             ...
             eout->info.screen = _e_comp_drm_output_screen_get(output);
...
EINTERN void
e_comp_drm_tdm_stub(void)
{}

EINTERN void
e_comp_drm_tdm_apply(void)
{
   Ecore_Drm_Device *dev;
   ...
   EINA_LIST_FOREACH(ecore_drm_devices_get(), l, dev)
     {
        ...
        EINA_LIST_FOREACH(e_comp_tdm->outputs, ll, eout)
          {
             ...
             mode = _e_comp_drm_mode_screen_find(eout, out);
...
{
   .available = e_comp_drm_tdm_available,
   .init = e_comp_drm_tdm_stub,
   .shutdown = e_comp_drm_tdm_stub,
   .init = e_comp_drm_tdm_init,
   .apply = e_comp_drm_tdm_apply,
   .dpms = e_comp_drm_tdm_dpms,
};
