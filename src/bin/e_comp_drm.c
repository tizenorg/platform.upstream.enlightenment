...
{
   .available = e_comp_screen_available,
   .init = e_comp_screen_stub,
   .shutdown = e_comp_screen_stub,
   .init = e_comp_screen_init_outputs,
   .apply = e_comp_screen_apply,
