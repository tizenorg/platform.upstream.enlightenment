...
TOKEN
_get_next_token(const char ** string)
{
...
static void
_process_token(TOKEN_DATA token)
{
   do
     {
...
_create_tree_node_from_statement(BINARY_TREE tree, TOKEN_DATA token)
{
...
static BINARY_TREE_NODE
_create_tree_node_from_token(BINARY_TREE tree, TOKEN_DATA token)
{
...
BINARY_TREE
_create_tree_from_rule_string(const char * string)
{
   BINARY_TREE tree;
...
static int
_print_rule_func(BINARY_TREE tree, BINARY_TREE_NODE node, BINARY_TREE_NODE parent, void * arg)
{
...
static int
_compare_string_by_comparer(COMPARER comparer, char * str2, char * str1)
{
...
static int
_compare_int_by_comparer(COMPARER comparer, int int2, int int1)
{
   switch (comparer)
     {
        case EQUAL:
...
static int
_validate_rule_func(BINARY_TREE tree, BINARY_TREE_NODE node, BINARY_TREE_NODE parent, void * arg)
{
...
static void
_merge_arguments (char *target, int target_size, int argc, const char ** argv)
{
   int i, len;
   ...
   if (!_strcasecmp(command, "add"))
     {
        ...
        _merge_arguments(merge, sizeof(merge), argc - 2, &(argv[2]));
