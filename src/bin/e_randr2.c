...
//atic void                    _config_apply(E_Randr2 *r, E_Config_Randr2 *cfg);
//atic int                     _config_screen_match_count(E_Randr2 *r, E_Config_Randr2 *cfg);
...
//        if (!cs)
//          {INF("========= %s \tcs creation ", __FUNCTION__);
...
//          }
//        if (cs)
//          {   INF("========= %s \tcs is existing(%f) ", __FUNCTION__, s->config.mode.refresh);
...
//atic E_Randr2_Screen *_screen_fuzzy_fallback_find(E_Config_Randr2 *cfg, const char *id);
