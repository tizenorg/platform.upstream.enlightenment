...
struct _E_Zone
{
   ...
   struct
   {
      int       x, y, w, h; // TODO: should be removed - yigl
      Eina_Bool dirty : 1; // TODO: should be removed - yigl
   } useful_geometry; // TODO: should be removed - yigl
   Eina_Bool      stowed : 1;
#ifdef _F_ZONE_WINDOW_ROTATION_
   struct
   {
...
E_API void      e_zone_desk_useful_geometry_get(const E_Zone *zone, const E_Desk *desk, int *x, int *y, int *w, int *h); // TODO: should be removed - yigl
