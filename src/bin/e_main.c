...
_e_main_path_init(void)
{
   ...
   //e_path_user_path_set(path_data, &(e_config->path_append_data)); // TODO: should be removed - yigl
   ...
   e_path_default_path_append(path_images, buf);
   //e_path_user_path_set(path_images, &(e_config->path_append_images)); // TODO: should be removed - yigl
   ...
   e_path_default_path_append(path_fonts, buf);
   //e_path_user_path_set(path_fonts, &(e_config->path_append_fonts)); // TODO: should be removed - yigl
   ...
   e_path_default_path_append(path_icons, buf);
   //e_path_user_path_set(path_icons, &(e_config->path_append_icons)); // TODO: should be removed - yigl
   ...
   e_path_default_path_append(path_modules, buf);
   //e_path_user_path_set(path_modules, &(e_config->path_append_modules)); // TODO: should be removed - yigl
   ...
   e_path_default_path_append(path_backgrounds, buf);
   //e_path_user_path_set(path_backgrounds, &(e_config->path_append_backgrounds)); // TODO: should be removed - yigl
   ...
   //e_path_user_path_set(path_messages, &(e_config->path_append_messages)); // TODO: should be removed - yigl
