...
src_bin_enlightenment_CPPFLAGS = $(E_CPPFLAGS) -DEFL_BETA_API_SUPPORT -DEFL_EO_API_SUPPORT -DE_LOGGING=1 @WAYLAND_CFLAGS@ @WAYLAND_EGL_CFLAGS@ @ECORE_X_CFLAGS@ -DNEED_WL
if ! HAVE_WAYLAND_ONLY
src_bin_enlightenment_CPPFLAGS += @ECORE_X_CFLAGS@ -DNEED_X
endif
...
if ! HAVE_WAYLAND_ONLY
src_bin_enlightenment_LDFLAGS += @ECORE_X_LIBS@
endif
