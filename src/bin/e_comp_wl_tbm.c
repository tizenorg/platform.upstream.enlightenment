...
e_comp_wl_tbm_init(void)
{
   ...
   if (e_comp->wl_comp_data->tbm.tbm_server)
      return EINA_TRUE;
   ...
   e_comp->wl_comp_data->tbm.tbm_server = (void *)tbm_server;
...
e_comp_wl_tbm_shutdown(void)
{
   ...
   wayland_tbm_server_deinit((struct wayland_tbm_server *)e_comp->wl_comp_data->tbm.tbm_server);

   e_comp->wl_comp_data->tbm.tbm_server = NULL;
}
