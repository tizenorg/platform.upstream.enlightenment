...
_send_gesture_signal(void *data, void *event_info)
{
   ...
   else if (gesture_type == ELM_GESTURE_N_FLICKS)
     {
...
static void _enable_gesture_service() {
   ...
   elm_gesture_layer_cb_set(gesture_layer, ELM_GESTURE_N_TAPS, ELM_GESTURE_STATE_MOVE,  _send_gesture_signal, (void *)(ELM_GESTURE_N_TAPS + 10000*ELM_GESTURE_STATE_MOVE));
   ...
   elm_gesture_layer_cb_set(gesture_layer, ELM_GESTURE_N_DOUBLE_TAPS, ELM_GESTURE_STATE_MOVE,  _send_gesture_signal, (void *)(ELM_GESTURE_N_DOUBLE_TAPS + 10000*ELM_GESTURE_STATE_MOVE));
...
//    elm_gesture_layer_cb_set(gesture_layer, ELM_GESTURE_N_FLICKS, ELM_GESTURE_STATE_MOVE,  _send_gesture_signal, (void *)(ELM_GESTURE_N_FLICKS + 10000*ELM_GESTURE_STATE_MOVE));
